<template>
  <div class="h-screen flex items-center">
    <section class="py-10 2xl:py-40 overflow-hidden">
      <div class="container px-4 mx-auto">
        <div class="max-w-5xl mx-auto">
          <div class="flex flex-wrap items-center -mx-10">
            <div class="w-full lg:w-1/2 px-10">
              <div
                class="px-6 lg:px-20 py-12 lg:py-24 bg-white shadow-2xl rounded-lg"
              >
                <div
                  v-if="showAlert"
                  class="bg-red-500 p-3 text-white mb-5 rounded text-center"
                >
                  Introduce a valid username
                </div>
                <form @submit.prevent="login">
                  <h3 class="mb-10 text-2xl font-bold font-heading text-center">
                    What's your name?
                  </h3>
                  <div
                    class="flex items-center pl-6 mb-3 border border-gray-300 bg-white rounded-full"
                  >
                    ...
                    <input
                      class="w-full pr-6 pl-4 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none"
                      type="text"
            ...
            <div
              class="w-full lg:w-1/2 px-10 mb-10 lg:mb-0 order-first lg:order-last flex flex-col"
            >
              <div class="max-w-md">
                <h2
                  class="mt-8 mb-12 text-5xl font-bold font-heading text-center"
                >
                  Welcome to our Walking Simulator
                </h2>
